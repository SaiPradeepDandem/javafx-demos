...
/**
 * {@link DragResizer} can be used to add mouse listeners to a {@link Region} and make it resizable by the user by clicking and dragging the
 * border in the same way as a window.
 * <p>
