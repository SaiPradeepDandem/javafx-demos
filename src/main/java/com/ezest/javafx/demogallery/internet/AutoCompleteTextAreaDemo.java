...
public class AutoCompleteTextAreaDemo extends Application
{
    public static void main(String[] args)
    {
        Application.launch(AutoCompleteTextAreaDemo.class, args);
    }
...
class AutoCompleteList<ItemType> extends BorderPane
{
